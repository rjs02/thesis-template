...
float patterns that most thesis projects need. Replace the placeholder drawings
with real files once figures are available.
...
\begin{figure}
	\centering
	\placeholderfigure[0.78\linewidth]{3.5cm}
...
\begin{figure*}
	\centering
	\placeholderfigure[0.92\linewidth]{4.2cm}
